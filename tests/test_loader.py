...
class InitializationTestMixin:
    ...
    def test_keep_single_value(self):
        ...
        self.assertEqual(ItemAdapter(loaded_item).as_dict(), {'name': ['foo']})
    ...
    def test_keep_list(self):
        ...
        loaded_item = il.load_item()
        self.assertIsInstance(loaded_item, self.item_class)
        self.assertEqual(ItemAdapter(loaded_item).as_dict(), {'name': ['foo', 'bar']})
    ...
    def test_add_value_singlevalue_list(self):
        ...
        loaded_item = il.load_item()
        self.assertIsInstance(loaded_item, self.item_class)
        self.assertEqual(ItemAdapter(loaded_item).as_dict(), {'name': ['foo', 'item', 'loader']})
    ...
    def test_add_value_list_singlevalue(self):
        ...
        loaded_item = il.load_item()
        self.assertIsInstance(loaded_item, self.item_class)
        self.assertEqual(ItemAdapter(loaded_item).as_dict(), {'name': ['foo', 'bar', 'qwerty']})
    ...
    def test_add_value_list_list(self):
        ...
        loaded_item = il.load_item()
        self.assertIsInstance(loaded_item, self.item_class)
        self.assertEqual(ItemAdapter(loaded_item).as_dict(), {'name': ['foo', 'bar', 'item', 'loader']})
    ...
    def test_get_output_value_singlevalue(self):
        ...
        loaded_item = il.load_item()
        self.assertIsInstance(loaded_item, self.item_class)
        self.assertEqual(ItemAdapter(loaded_item).as_dict(), dict({'name': ['foo']}))
    ...
    def test_get_output_value_list(self):
        ...
        loaded_item = il.load_item()
        self.assertIsInstance(loaded_item, self.item_class)
        self.assertEqual(ItemAdapter(loaded_item).as_dict(), dict({'name': ['foo', 'bar']}))
