...
from adhoc_tool.annotated_sources.annotated_engine import ExecutionEngine
...
class EngineTest(unittest.TestCase):
    ...
    def tearDownClass(cls):
        ...
        if 'annotated_engine' not in sys.modules:
    ...
    @defer.inlineCallbacks
    def test_next_request_no_slot(self):
        """
        _next_request should return without attempting to 
        fetch next request if the Slot object is None
        """
