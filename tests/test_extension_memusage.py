...
class TestMemoryUsage:
    ...
    async def test_memory_warning_logs_and_completes_crawl(self):
    ...
    async def test_memory_warning_with_email_notification(self):
    ...
    async def test_memory_limit_with_email_notification(self):
