...
class CrawlTestCase(TestCase):
    ...
    def test_follow_all(self):
        ...
        yield crawler.crawl(address=self.mockserver)
    ...
    def _test_delay(self, delay, randomize):
        ...
        yield crawler.crawl(maxlatency=delay * 2, address=self.mockserver)
    ...
    def test_timeout_success(self):
        ...
        yield crawler.crawl(n=0.5, address=self.mockserver)
    ...
    def test_timeout_failure(self):
        ...
        yield crawler.crawl(n=0.5, b=1, address=self.mockserver)
        self.assertTrue(crawler.spider.t1 > 0)
        self.assertTrue(crawler.spider.t2 == 0)
        self.assertTrue(crawler.spider.t2_err > 0)
        self.assertTrue(crawler.spider.t2_err > crawler.spider.t1)
    ...
    def test_retry_503(self):
        ...
        with LogCapture() as l:
            yield crawler.crawl(self.mockserver.url("/status?n=503"), address=self.mockserver)
    ...
    def test_retry_conn_failed(self):
        crawler = self.runner.create_crawler(SimpleSpider)
        with LogCapture() as l:
            yield crawler.crawl("http://localhost:65432/status?n=503", address=self.mockserver)
        self._assert_retried(l)
    ...
    def test_retry_dns_error(self):
        ...
        with LogCapture() as l:
            ...
            yield crawler.crawl("http://dns.resolution.invalid./", address=self.mockserver)
        self._assert_retried(l)
    ...
    def test_start_requests_bug_before_yield(self):
        with LogCapture('scrapy', level=logging.ERROR) as l:
            ...
            yield crawler.crawl(fail_before_yield=1, address=self.mockserver)
    ...
    def test_start_requests_bug_yielding(self):
        with LogCapture('scrapy', level=logging.ERROR) as l:
            crawler = self.runner.create_crawler(BrokenStartRequestsSpider)
            yield crawler.crawl(fail_yielding=1, address=self.mockserver)
    ...
    def test_start_requests_dupes(self):
        ...
        yield crawler.crawl(dont_filter=True, distinct_urls=2, dupe_factor=3, address=self.mockserver)
        self.assertEqual(crawler.spider.visited, 6)

        yield crawler.crawl(dont_filter=False, distinct_urls=3, dupe_factor=4, address=self.mockserver)
...
'''})
        crawler = self.runner.create_crawler(SimpleSpider)
        with LogCapture() as l:
            yield crawler.crawl(self.mockserver.url("/raw?{0}".format(query)), address=self.mockserver)
    ...
    def test_retry_conn_lost(self):
        ...
        crawler = self.runner.create_crawler(SimpleSpider)
        with LogCapture() as l:
            yield crawler.crawl(self.mockserver.url("/drop?abort=0"), address=self.mockserver)
        self._assert_retried(l)
    ...
    def test_retry_conn_aborted(self):
        ...
        crawler = self.runner.create_crawler(SimpleSpider)
        with LogCapture() as l:
            yield crawler.crawl(self.mockserver.url("/drop?abort=1"), address=self.mockserver)
        self._assert_retried(l)
    ...
    def test_referer_header(self):
        ...
        yield crawler.crawl(seed=req0, address=self.mockserver)
    ...
    def test_engine_status(self):
        ...
        crawler = self.runner.create_crawler(SingleRequestSpider)
        yield crawler.crawl(seed=self.mockserver.url('/'), callback_func=cb, address=self.mockserver)
    ...
    def test_graceful_crawl_error_handling(self):
        ...
        yield self.assertFailure(crawler.crawl(address=self.mockserver), TestError)
    ...
    def test_open_spider_error_on_faulty_pipeline(self):
        ...
        yield self.assertFailure(
            self.runner.crawl(crawler, self.mockserver.url("/status?n=200"), address=self.mockserver),
            ZeroDivisionError)
        self.assertFalse(crawler.crawling)
    ...
    def test_crawlerrunner_accepts_crawler(self):
        ...
        with LogCapture() as log:
            yield self.runner.crawl(crawler, self.mockserver.url("/status?n=200"), address=self.mockserver)
        self.assertIn("Got response 200", str(log))

    @defer.inlineCallbacks
    def test_crawl_multiple(self):
        self.runner.crawl(SimpleSpider, self.mockserver.url("/status?n=200"), address=self.mockserver)
        self.runner.crawl(SimpleSpider, self.mockserver.url("/status?n=503"), address=self.mockserver)
