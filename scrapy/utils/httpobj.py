...
# For scrapy.extensions.httpcache.WARCCacheStorage.
# Because scrapy either doesn't expose or capture the HTTP status message,
# so we reconstruct it when building WARC Response records for caching.
HTTP_STATUS_MSGS = {
    100: "Continue",
