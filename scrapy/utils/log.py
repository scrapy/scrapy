...
async def log_crawler_awaitable(crawler: Crawler, awaitable: Awaitable[_T]) -> _T:
    previous_crawler = get_log_crawler()
    _log_crawler.set(crawler)
    try:
        return await awaitable
    finally:
        _log_crawler.set(previous_crawler)
