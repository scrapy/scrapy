...
def feed_complete_default_values_from_settings(feed, settings):
    ...
    out.setdefault("batch_time_duration", settings.getint('FEED_EXPORT_BATCH_TIME_DURATION'))
    out.setdefault("batch_file_size", settings.getint('FEED_EXPORT_BATCH_FILE_SIZE'))
