...
def request_fingerprint(request, include_headers=None, keep_fragments=False, as_bytes=False):
    ...
    if include_headers or keep_fragments:
        message = (
            ...
            '\n'
            'If you are using this class in a Scrapy component because you '
        ...
        message = (
            ...
            'scrapy.utils.request.request_fingerprint().\n'
            '\n'
            'If you are using this class in a Scrapy component, and you are '
            'OK with users of your component changing the fingerprinting '
    ...
    def __init__(self, crawler=None):
        ...
        if implementation == '2.3':
            ...
            raise ValueError(
                ...
                f'‘REQUEST_FINGERPRINTER_IMPLEMENTATION’: {implementation!r}. '
                f'Valid values are \'2.3\' (deprecated) and \'2.4\'.'
            )
