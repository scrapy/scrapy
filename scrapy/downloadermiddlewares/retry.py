...
class RetryMiddleware:
    ...
    def _retry(
        ...
        # MODIFICATION: Check the state of dont_filter on the *original* failing request.
        dont_filter_was_set = request.dont_filter
        ...
        # MODIFICATION: Only add the meta flag if the original request did NOT have
        # dont_filter set. This ensures we only undo the dont_filter that this
        # middleware itself has set, preserving user-defined values.
        if new_request and not dont_filter_was_set:
            new_request.meta['_retry_dont_filter'] = True
