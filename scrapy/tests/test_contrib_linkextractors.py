...
class LinkExtractorTestCase(unittest.TestCase):
    ...
    def test_basic(self):
        ...
        self.assertEqual(lx.extract_links(response),
                         [Link(url='http://example.org/somepage/item/12.html', text='Item 12'),
                          Link(
                              url='http://example.org/about.html', text='About us'),
                          Link(
                              url='http://example.org/othercat.html', text='Other category'),
    ...
    def test_link_text_wrong_encoding(self):
        ...
        response = HtmlResponse(
            "http://www.example.com", body=html, encoding='utf-8')
    ...
    def test_link_nofollow(self):
        ...
        self.assertEqual([link for link in lx.extract_links(response)], [
            Link(url='http://example.org/page.html?action=print',
                 text=u'Printer-friendly page', nofollow=True),
            Link(url='http://example.org/about.html',
                 text=u'About us', nofollow=False),
        ])
...
class SgmlLinkExtractorTestCase(unittest.TestCase):
    ...
    def test_restrict_xpaths_encoding(self):
        ...
        response = HtmlResponse(
            "http://example.org/somepage/index.html", body=html, encoding='windows-1252')
    ...
    def test_restrict_xpaths_with_html_entities(self):
        ...
        response = HtmlResponse(
            "http://example.org/somepage/index.html", body=html, encoding='iso8859-15')
    ...
    def test_restrict_xpaths_concat_in_handle_data(self):
        ...
        response = HtmlResponse(
            "http://example.org", body=body, encoding='gb18030')
    ...
    def test_encoded_url(self):
        ...
        self.assertEqual(lx.extract_links(response), [
            Link(url='http://known.fm/AC%2FDC/?page=2',
                 text=u'BinB', fragment='', nofollow=False),
        ])
...
class HtmlParserLinkExtractorTestCase(unittest.TestCase):
    ...
    def test_extraction(self):
        ...
        self.assertEqual(lx.extract_links(self.response),
                         [Link(url='http://example.com/sample2.html', text=u'sample 2'),
                          Link(
                              url='http://example.com/sample3.html', text=u'sample 3 text'),
                          Link(url='http://example.com/sample3.html',
                               text=u'sample 3 repetition'),
                          Link(
                              url='http://www.google.com/something', text=u''),
                          Link(url='http://example.com/innertag.html', text=u'inner tag'), ])
