...
class Rule:
    ...
    *name* identifies the rule, to be used as a target of the *from_rules* of
    other rules.

    *from_rules* is the *name* of another rule, or an iterable of names. If
    set, this rule is only applied to responses reached through one of those
    rules, instead of to every response.
    """
