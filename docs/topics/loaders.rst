...
Scrapy provides some commonly used processors in
:mod:`scrapy.loader.processors`.

Some of them, like the :class:`~scrapy.loader.processors.MapCompose` (which is
