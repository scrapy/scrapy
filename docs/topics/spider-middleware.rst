...
the :meth:`~scrapy.spidermiddlewares.BaseSpiderMiddleware.process_spider_input`
method of each middleware will be invoked in increasing
middleware order (100, 200, 300, ...), and the
:meth:`~scrapy.spidermiddlewares.BaseSpiderMiddleware.process_spider_output` method
...
Each middleware component is a Python class that inherits from this class:
