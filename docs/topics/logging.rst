...
If :setting:`LOG_TOPLEVEL` is set, then the logs will not display the component
that prints the log. It is unset by default, hence logs contain the component
responsible for that log output.
