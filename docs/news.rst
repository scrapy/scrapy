...
- Replace unencodeable codepoints with html entities in SGMLLinkExtractor
  (:issue:`565`)
- Improved testsuite comparing CSV and XML exporters (:issue:`570`)
- New offsite/filtered and offsite/domains stats (:issue:`566`)
- Fixed link text when there is an inner tag in SGMLLinkExtractor and
...
- Converted SEP documents to rst format (:issue:`629`, :issue:`630`,
  ...
  :issue:`641`, :issue:`642`)
- Tests and docs for clickdata's nr index in FormRequest (:issue:`646`,
  :issue:`645`)
...
- Infer exporter's output format from filename extensions (:issue:`546`, :issue:`659`)
...
- Added selector method shortcuts to responses (:issue:`554`, :issue:`690`)
